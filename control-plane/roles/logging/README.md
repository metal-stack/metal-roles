...
| logging_gateway_enabled                  |           | `true`                                       | Enables Loki gateway                                                                                                                                                                                        |
| logging_ingress_enabled                  |           | `true`                                       | If enabled, deploys an Ingress resource for Loki.                                                                                                                                                           |
| logging_ingress_dns                      |           | `loki.{{ metal_control_plane_ingress_dns }}` | DNS name for the Loki ingress                                                                                                                                                                               |
| logging_ingress_loki_tls                 |           | `true`                                       | Enable TLS on the Loki ingress and force HTTP->HTTPS redirect. Set to `false` for HTTP-only environments.                                                                                                   |
| logging_ingress_loki_basic_auth_user     |           | `promtail`                                   | Basic auth username for the Loki gateway.                                                                                                                                                                   |
| logging_ingress_loki_basic_auth_password | yes       |                                              | Basic auth password for the Loki gateway.                                                                                                                                                                   |
| logging_ingress_annotations              |           | `{}`                                         | Additional annotations for the Loki ingress resource                                                                                                                                                        |
| logging_gateway_dns                      |           | `loki.{{ metal_control_plane_gateway_dns }}` | The dns name used for exposing Loki via Gateway API routes (when *_httproute_enabled is set)                                                                                                                |
| logging_httproute_enabled                |           | `false`                                      | Deploys a Gateway API HTTPRoute for Thanos Receive                                                                                                                                                          |
| logging_httproute_parent_refs            |           | `[]`                                         | List of `parentRefs` (Gateways) the HTTPRoute attaches to                                                                                                                                                   |
