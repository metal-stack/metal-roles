...
| logging_ingress_loki_basic_auth_user          |           | `promtail`                                   | Basic auth username for the external Loki ingress. Requires `logging_ingress_loki_tls: true`.                                                                                                               |
| logging_ingress_loki_basic_auth_password      | yes       |                                              | Basic auth password for the external Loki ingress. Requires `logging_ingress_loki_tls: true`.`.                                                                                                             |
| logging_ingress_loki_basic_auth_password_salt |           | derived from password                        | Salt for stable bcrypt hashes                                                                                                                                                                               |
