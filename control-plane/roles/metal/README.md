...
| metal_api_bmc_supermetal_enabled |           | Enables creating the BMC superuser 'supermetal' and disabling the default one |
| metal_api_bmc_supermetal_pwd     |           | If enabled use this password for the new BMC superuser                        |
