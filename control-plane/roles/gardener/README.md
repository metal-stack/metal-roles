...
| gardener_etcd_image_name                             |           | Optional overwrite for the etcd image name from the etcd-backup-restore helm chart                                                                                                           |
| gardener_etcdbrctl_image_name                        |           | Optional overwrite for the etcdbrctl image name from the etcd-backup-restore helm chart                                                                                                      |
