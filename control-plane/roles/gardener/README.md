...
| gardener_logging_enabled                                    |           | Specifies whether the logging stack should be activated                                                                                                                                                                                                                       |
| gardener_logging_vali_enabled                               |           | Specifies whether the shoot and seli Vali should be activated                                                                                                                                                                                                                 |
| gardener_logging_vali_garden_storage                        |           | Specifies central Vali storage capacity                                                                                                                                                                                                                                       |
