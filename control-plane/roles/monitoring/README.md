...
| monitoring_custom_dashboard_folder            |           | Folder where the custom dashboards a located in the deployment.                                                               |
| monitoring_custom_dashboard_file_list         |           | List of filenames in the `monitoring_custom_dashboard_folder` with config maps, that include a grafana dashboard json. |
