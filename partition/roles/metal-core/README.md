...
| metal_core_room_id                        | yes       | The room id describing the room in which the rack is located. Can be a logical room name and is used by the metal-api to add corresponding tags to switches and machines   |
