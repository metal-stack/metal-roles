...
| metal_core_loopback_ip                    | yes       | The loopback ip address that is used with BGP unnumbered                                                                                                                                                     |
| metal_core_asn                            | yes       | The ASN that is used with BGP                                                                                                                                                                                |
...
| metal_core_additional_bridge_vids         |           | Additional vlan ids that should be configured at the vlan-aware bridge                                                                                                                                       |
| metal_core_additional_bridge_ports        |           | Additional switch ports that should be configured at the vlan-aware bridge                                                                                                                                   |
