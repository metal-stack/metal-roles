...
| metal_core_additional_mgmt_routes         |           | Additional destination CIDRs that are routed to the management network gateway next to the default route. Requires a metal-core with metal-stack/metal-core#204.            |
