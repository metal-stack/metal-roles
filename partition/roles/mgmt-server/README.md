...
| mgmt_server_ssh_config_options        | no        | in hostvars of inventory objects, options that will be added to the mgmtserver's ssh config for this host |
| mgmt_server_additional_ssh_keys       | no        | dict of additional private ssh keys to copy into the metal user's ssh directory                           |
